...
export default {
  ...
  methods: {
    ...
    fetchBookChapter (index) {
      ...
      axios
        .get(`http://${process.env.VUE_APP_BACKEND_DOMAIN}/reading-material/book-chapters/${this.reading_materials[index].id}/`)
        .then((response) => {
    ...
    fetchStoryContent (index) {
      ...
      axios
        .get(`http://${process.env.VUE_APP_BACKEND_DOMAIN}/reading-material/story-content/${this.reading_materials[index].id}/`)
        .then((response) => {
    ...
    fetchChapterContent (id, title) {
      ...
      axios
        .get(`http://${process.env.VUE_APP_BACKEND_DOMAIN}/reading-material/chapter-content/${id}/`)
        .then((response) => {
          this.$emit('content-changed', response.data.data)
